---
title: "ADR-001: IAsyncEnumerable<T> as the Reader Contract"
---
...
See [Core API](/api/core) for the current `IItemReader<T>` signature, and [Restartability](/guide/restartability) for how readers checkpoint their position.
