...
public partial class InitialCreate : Migration
{
    ...
    {
        migrationBuilder.DropTable(name: "batch_step_executions");
        migrationBuilder.DropTable(name: "batch_job_executions");
        migrationBuilder.DropTable(name: "batch_job_instances");
    }
}
