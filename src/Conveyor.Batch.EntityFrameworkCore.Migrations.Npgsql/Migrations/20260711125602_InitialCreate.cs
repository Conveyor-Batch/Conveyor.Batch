        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemTypeName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailureMessage = table.Column<string>(type: "text", nullable: true),
                    ExecutionContextJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
